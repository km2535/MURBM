...
const Resource = ({ cld }) => {
  const resource = cld.image("murbm/resource.webp");
  const hr = cld.image("murbm/Human_resource.jpg");
  return (
    <section className={style.container}>
      <div className={style.banner}>
        <h1 className={style.bannerTitle}>
          ...
          <span className={style.bannerSubTittle}>핵심 자원</span>
          <br></br>
        ...
        <AdvancedImage cldImg={resource} className={style.bannerImg} />
      </div>
      <div className={style.content}>
        <AdvancedImage cldImg={hr} className={style.contentImg} />
